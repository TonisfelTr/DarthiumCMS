...
if (!$user->UserGroup()->getPermission("change_engine_settings")) {
    ...
    <div class="inner cover">
        ...
        <div id="btn-show-panel" class="btn-group">
            <button type="button" class="btn btn-default active" data-div-number="1"><span
                        class="glyphicon glyphicon-cog"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.configuration"); ?>
            </button>
            <button type="button" class="btn btn-default" data-div-number="2"><span
                        class="glyphicon glyphicon-envelope"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.bot_postman"); ?>
            </button>
            <button type="button" class="btn btn-default" data-div-number="3"><span
                        class="glyphicon glyphicon-pencil"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.registration"); ?>
            </button>
            <button type="button" class="btn btn-default" data-div-number="4"><span
                        class="glyphicon glyphicon-user"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users"); ?>
            </button>
            <button type="button" class="btn btn-default" data-div-number="5"><span
                        class="glyphicons glyphicons-book"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.plugins"); ?>
            </button>
            <button type="button" class="btn btn-default" data-div-number="6"><span
                        class="glyphicons glyphicons-pie-chart"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.statistic"); ?>
            </button>
        </div>
        ...
        <form name="settings" method="post" action="adminpanel/scripts/replacer.php">
            <div class="custom-group">
                <div class="div-border" id="custom_sets" data-number="1">
                    <h3>
                        <span class="glyphicon glyphicon-cog"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.panel_name"); ?>
                    </h3>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="sitename"
                               value="<?php echo htmlentities(\Engine\Engine::GetEngineInfo("sn")); ?>">
                        <div class="form-control info alert-info"><span
                                    class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.site_name_tip"); ?>
                        </div>
                    </div>
                    <div class="input-group">
                        <div class="input-group-addon"><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.tagline"); ?></div>
                        <input type="text" class="form-control" name="sitetagline"
                               value="<?php echo htmlentities(\Engine\Engine::GetEngineInfo("stl")); ?>">
                        <div class="form-control info alert-info"><span
                                    class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.tagline_tip"); ?>
                        </div>
                    </div>
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="domain"
                               value="<?php echo htmlentities(\Engine\Engine::GetEngineInfo("dm")); ?>">
                        <div class="form-control info alert-info"><span
                                    class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.domain_tip"); ?>
                        </div>
                    </div>
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="sitesubscribe"
                               value="<?php echo htmlentities(\Engine\Engine::GetEngineInfo("ssc")); ?>">
                        <div class="form-control info alert-info"><span
                                    class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.site_description_tip"); ?>
                        </div>
                    </div>
                    <div class="input-group">
                        <div class="input-group-addon"><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.hashtags"); ?></div>
                        <input type="text" class="form-control" name="sitehashtags"
                               value="<?php echo htmlentities(\Engine\Engine::GetEngineInfo("sh")); ?>">
                        <div class="form-control info alert-info"><span
                                    class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.hashtags_tip"); ?>
                        </div>
                    </div>
                    <div class="input-group">
                        ...
                        <select class="form-control" name="sitestatus">
                            <option value="1" <?php if (\Engine\Engine::GetEngineInfo("ss") == 1) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("on"); ?></option>
                            <option value="0" <?php if (\Engine\Engine::GetEngineInfo("ss") == 0) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("off"); ?></option>
                        </select>
                        <div class="form-control info alert-info"><span
                                    class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.status_tip"); ?>
                        </div>
                    </div>
                    <div class="input-group">
                        ...
                        <div class="form-control info alert-info"><span
                                    class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.template_tip"); ?>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" name="sitelang">
                            <?php if (\Engine\Engine::GetEngineInfo("sl") === 0) { ?>
                                <option value="0" selected>&lt;<?= \Engine\LanguageManager::GetTranslation("empty") ?>
                                &gt;</option><?php }
                            /*Перебрать названия языков...*/
                            for ($i = 0; $i <= count($langs) - 1; $i++) { ?>
                                <option value="<?php echo $langs[$i]; ?>" <?php if (\Engine\Engine::GetEngineInfo("sl") == $langs[$i]) {
                                    echo " selected";
                                } ?>><?php echo $langs[$i]; ?></option>
                            <?php } ?>
                        </select>
                        <div class="form-control info alert-info"><span
                                    class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.lang_tip"); ?>
                        </div>
                    </div>
                    <div class="input-group">
                        ...
                        <select class="form-control" name="siteregiontime">
                            <option value="-12" <?php if (\Engine\Engine::GetEngineInfo("srt") == -12) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc-12"); ?></option>
                            <option value="-11" <?php if (\Engine\Engine::GetEngineInfo("srt") == -11) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc-11"); ?></option>
                            <option value="-10" <?php if (\Engine\Engine::GetEngineInfo("srt") == -10) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc-10"); ?></option>
                            <option value="-9.5" <?php if (\Engine\Engine::GetEngineInfo("srt") == -9.5) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc-9:30"); ?></option>
                            <option value="-9" <?php if (\Engine\Engine::GetEngineInfo("srt") == -9) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc-9"); ?></option>
                            <option value="-8" <?php if (\Engine\Engine::GetEngineInfo("srt") == -8) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc-8"); ?></option>
                            <option value="-7" <?php if (\Engine\Engine::GetEngineInfo("srt") == -7) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc-7"); ?></option>
                            <option value="-6" <?php if (\Engine\Engine::GetEngineInfo("srt") == -6) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc-6"); ?></option>
                            <option value="-5" <?php if (\Engine\Engine::GetEngineInfo("srt") == -5) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc-5"); ?></option>
                            <option value="-4" <?php if (\Engine\Engine::GetEngineInfo("srt") == -4) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc-4"); ?></option>
                            <option value="-3.5" <?php if (\Engine\Engine::GetEngineInfo("srt") == -3.5) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc-3:30"); ?></option>
                            <option value="-3" <?php if (\Engine\Engine::GetEngineInfo("srt") == -3) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc-3"); ?></option>
                            <option value="-2" <?php if (\Engine\Engine::GetEngineInfo("srt") == -2) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc-2"); ?></option>
                            <option value="-1" <?php if (\Engine\Engine::GetEngineInfo("srt") == -1) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc-1"); ?></option>
                            <option value="0" <?php if (\Engine\Engine::GetEngineInfo("srt") == 0) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc"); ?></option>
                            <option value="1" <?php if (\Engine\Engine::GetEngineInfo("srt") == 1) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+1"); ?></option>
                            <option value="2" <?php if (\Engine\Engine::GetEngineInfo("srt") == 2) {
                            ...
                            <option value="4.5" <?php if (\Engine\Engine::GetEngineInfo("srt") == 4.5) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+4:30"); ?></option>
                            <option value="5" <?php if (\Engine\Engine::GetEngineInfo("srt") == 5) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+5"); ?></option>
                            <option value="5.5" <?php if (\Engine\Engine::GetEngineInfo("srt") == 5.5) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+5:30"); ?></option>
                            <option value="5.75" <?php if (\Engine\Engine::GetEngineInfo("srt") == 5.75) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+5:45"); ?></option>
                            <option value="6" <?php if (\Engine\Engine::GetEngineInfo("srt") == 6) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+6"); ?></option>
                            <option value="6.5" <?php if (\Engine\Engine::GetEngineInfo("srt") == 6.5) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+6:30"); ?></option>
                            <option value="7" <?php if (\Engine\Engine::GetEngineInfo("srt") == 7) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+7"); ?></option>
                            <option value="8" <?php if (\Engine\Engine::GetEngineInfo("srt") == 8) {
                            ...
                            <option value="8.5" <?php if (\Engine\Engine::GetEngineInfo("srt") == 8.5) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+8:30"); ?></option>
                            <option value="8.75" <?php if (\Engine\Engine::GetEngineInfo("srt") == 8.75) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+8:45"); ?></option>
                            <option value="9" <?php if (\Engine\Engine::GetEngineInfo("srt") == 9) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+9"); ?></option>
                            <option value="9.5" <?php if (\Engine\Engine::GetEngineInfo("srt") == 9.5) {
                            ...
                            <option value="10.5" <?php if (\Engine\Engine::GetEngineInfo("srt") == 10.5) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+10:30"); ?></option>
                            <option value="11" <?php if (\Engine\Engine::GetEngineInfo("srt") == 11) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+11"); ?></option>
                            <option value="12" <?php if (\Engine\Engine::GetEngineInfo("srt") == 12) {
                            ...
                            <option value="12.75" <?php if (\Engine\Engine::GetEngineInfo("srt") == 12.75) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+12:45"); ?></option>
                            <option value="13" <?php if (\Engine\Engine::GetEngineInfo("srt") == 13) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+13"); ?></option>
                            <option value="14" <?php if (\Engine\Engine::GetEngineInfo("srt") == 14) {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezones.utc+14"); ?></option>
                        </select>
                        <div class="form-control info alert-info"><span
                                    class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.config_panel.timezone_tip"); ?>
                        </div>
                    </div>
                </div>
                <div class="div-border" id="email_sets" data-number="2" hidden>
                    <h3>
                        <span class="glyphicon glyphicon-envelope"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.bot_postman_panel.panel_name"); ?>
                    </h3>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="emaillogin"
                               value="<?php echo htmlentities(\Engine\Engine::GetEngineInfo("el")); ?>">
                    </div>
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" name="emailpassword"
                               value="<?php echo htmlentities(\Engine\Engine::GetEngineInfo("ep")); ?>">
                    </div>
                    <div class="input-group">
                        ...
                        <select class="form-control" name="emailconnecttype">
                            <option value="tls" <?php if (\Engine\Engine::GetEngineInfo("ecp") == "tls") {
                                echo "selected";
                            } ?>>TLS
                            </option>
                            <option value="ssl" <?php if (\Engine\Engine::GetEngineInfo("ecp") == "ssl") {
                                echo "selected";
                            } ?>>SSL
                            </option>
                        </select>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="emailhost"
                               value="<?php echo htmlentities(\Engine\Engine::GetEngineInfo("eh")); ?>">
                    </div>
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="emailport"
                               value="<?php echo htmlentities(\Engine\Engine::GetEngineInfo("ept")); ?>">
                    </div>
                    <br>
                    ...
                    <button class="btn btn-default" id="mail-test-ajax-btn" type="button" style="width: 100%;"><span
                                class="glyphicons glyphicons-message-out"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.bot_postman_panel.email_check_validity"); ?>
                    </button>
                </div>
                <div class="div-border" id="reg_sets" data-number="3" hidden>
                    <h3>
                        <span class="glyphicon glyphicon-pencil"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.registration_panel.panel_name"); ?>
                    </h3>
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" name="needactivate">
                            <option value="1" <?php if (\Engine\Engine::GetEngineInfo("na") == "1") {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.registration_panel.activation_on"); ?></option>
                            <option value="0" <?php if (\Engine\Engine::GetEngineInfo("na") == "0") {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.registration_panel.activation_off"); ?></option>
                        </select>
                        <div class="form-control info alert-info"><span
                                    class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.registration_panel.activation_tip"); ?>
                        </div>
                    </div>
                    <div class="input-group">
                        ...
                        <select class="form-control" name="multiaccount" id="multiaccount">
                            <option value="1" <?php if (\Engine\Engine::GetEngineInfo("map") == "y") {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("on"); ?></option>
                            <option value="0" <?php if (\Engine\Engine::GetEngineInfo("map") == "n") {
                                echo "selected";
                            } ?>><?php echo \Engine\LanguageManager::GetTranslation("off"); ?></option>
                        </select>
                        <div class="form-control info alert-info"><span
                                    class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.registration_panel.multiacc_tip"); ?>
                        </div>
                    </div>
                    <hr>
                    <div class="input-group">
                        ...
                        <select class="form-control" name="standartgroup">
                            ...
                            foreach ($groupList as $group) {
                                echo "<option value=\"" . $group["id"] . "\"" . ((\Engine\Engine::GetEngineInfo("sg") == $group["id"])
                                        ? " selected" : "") . ">" .
                        ...
                        <div class="form-control info alert-info"><span
                                    class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.registration_panel.reggroup_tip"); ?>
                        </div>
                    </div>
                </div>
                <div class="div-border" id="users_sets" data-number="4" hidden>
                    <h3>
                        <span class="glyphicon glyphicon-user"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.panel_name"); ?>
                    </h3>
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-btn">
                            <button class="btn btn-default" type="button" id="field-add-btn"
                                    title="<?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.additive_field_plus_btn_title"); ?>">
                                <span class="glyphicons glyphicons-plus"></span></button>
                            <button class="btn btn-default" type="button" id="field-remove-btn"
                                    title="<?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.additive_field_minus_btn_title"); ?>"
                                    disabled><span class="glyphicons glyphicons-minus"></span></button>
                        </div>
                    </div>
                    <div id="field-panel-manage" class="div-border" style="display: none; margin-top: 15px;">
                        <div class="input-group">
                            ...
                            <div class="form-control info alert-info"><span
                                        class="glyphicons glyphicons-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.af_name_tip"); ?>
                            </div>
                        </div>
                        <br>
                        <div class="input-group">
                            ...
                            <div class="form-control info alert-info"><span
                                        class="glyphicons glyphicons-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.af_description_tip"); ?>
                            </div>
                        </div>
                        <br>
                        <div class="input-group">
                            ...
                            <div class="form-control info alert-info"><span
                                        class="glyphicons glyphicons-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.af_type.tip"); ?>
                            </div>
                        </div>
                        <br>
                        <div class="input-group" id="custom-value-input-div" hidden>
                            ...
                            <div class="form-control info alert-info"><span
                                        class="glyphicons glyphicons-info-sign"></span> Стандартное значение поля.
                            </div>
                        </div>
                        <br>
                        <div class="input-group" id="require-input-div" hidden>
                            ...
                            <div class="form-control info alert-info"><span
                                        class="glyphicons glyphicons-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.af_requied_tip"); ?>
                            </div>
                        </div>
                        <br>
                        <div class="input-group" id="see-on-reg-input-div" hidden>
                            ...
                            <div class="form-control info alert-info"><span
                                        class="glyphicons glyphicons-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.af_visible_in_registration_tip"); ?>
                            </div>
                        </div>
                        <br>
                        <div class="input-group" id="private-input-div" hidden>
                            ...
                            <div class="form-control info alert-info"><span
                                        class="glyphicons glyphicons-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.af_can_be_private_tip"); ?>
                            </div>
                        </div>
                        <br>
                        <div class="input-group" id="link-input-div">
                            ...
                            <div class="form-control info alert-info"><span
                                        class="glyphicons glyphicons-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.af_link_tip_first"); ?>
                            </div>
                            <div class="form-control info alert-info"><span
                                        class="glyphicons glyphicons-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.af_link_tip_second"); ?>
                            </div>
                            <textarea class="form-control" name="field-link-textarea"
                                      style="resize: vertical; min-height: 100px;" id="field-link-textarea"></textarea>
                        </div>
                        <br>
                        <div class="btn-group">
                            <button class="btn btn-default" type="button" id="field-add-ajax-btn"><span
                                        class="glyphicons glyphicons-ok"></span> <?php echo \Engine\LanguageManager::GetTranslation("apply"); ?>
                            </button>
                            <button class="btn btn-default" type="button" id="field-cancel-btn"><span
                                        class="glyphicons glyphicons-erase"></span> <?php echo \Engine\LanguageManager::GetTranslation("cancel"); ?>
                            </button>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="input-group">
                        ...
                        <textarea class="form-control" style="resize: vertical; min-height: 100px;"
                                  name="reports-reasons"><?php echo \Engine\Engine::GetReportReasons(); ?></textarea>
                    </div>
                    <div class="alert alert-info"><span
                                class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.reports_tip"); ?>
                    </div>
                    <hr>
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" name="avatarmaxwidth"
                               value="<?php echo htmlentities(\Engine\Engine::GetEngineInfo("aw")); ?>">
                    </div>
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" name="avatarmaxheight"
                               value="<?php echo htmlentities(\Engine\Engine::GetEngineInfo("ah")); ?>">
                    </div>
                    <hr>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="uploadformats"
                               value="<?php echo htmlentities(\Engine\Engine::GetEngineInfo("upf")); ?>">
                    </div>
                    <div class="alert alert-info"><span
                                class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.valid_formats_tip"); ?>
                    </div>
                    <div class="input-group">
                        <div class="input-group-addon"><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.max_file_size"); ?></div>
                        <input type="number" class="form-control" name="maxfilesize" id="maxfilesize"
                               value="<?php echo htmlentities(\Engine\Engine::GetEngineInfo("ups")); ?>">
                    </div>
                    <div class="alert alert-info"><span
                                class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.max_file_size_tip.first_part");
                        ?> <span
                                id="file-max-size-inmb"><?php echo \Engine\Engine::GetEngineInfo("ups") / 1024 / 1024; ?></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.max_file_size_tip.second_part"); ?>
                    </div>
                    <hr>
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-control">
                            <input type="checkbox"
                                   name="guest_see_profiles" <?php if (\Engine\Engine::GetEngineInfo("gsp")) {
                                echo "checked";
                            } ?>>
                        </div>
                    </div>
                    <div class="alert alert-info"><span
                                class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.guest_see_profile_tip"); ?>
                    </div>
                    <div class="input-group">
                        <div class="input-group-addon"><?php echo \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.multivote_rep"); ?></div>
                        <div class="form-control">
                            <input type="checkbox"
                                   name="multivote_rep" <?php if (\Engine\Engine::GetEngineInfo("vmr")) {
                                echo "checked";
                            } ?>>
                        </div>
                        <div class="form-control alert-info"><span
                                    class="glyphicons glyphicons-info-sign"></span> <?= \Engine\LanguageManager::GetTranslation("settings_panel.users_panel.multivote_rep_tip") ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="div-border" id="metric_sets" data-number="6" hidden>
                    <h3>
                        <span class="glyphicons glyphicons-pie-chart"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.statistic_panel.panel_name"); ?>
                    </h3>
                    ...
                    <div class="input-group" id="metric-code-div">
                        ...
                        <textarea class="form-control" style="height: 300px; resize: none;"
                                  name="metric-script-text"><?php echo \Engine\Engine::GetAnalyticScript(); ?></textarea>
                        <div class="form-control info alert-info"><span
                                    class="glyphicons glyphicons-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_panel.statistic_panel.text_to_insert_tip"); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="btn-group" role="group">
                <button type="submit" class="btn btn-default"
                        name="save_cfg_button"><?php echo \Engine\LanguageManager::GetTranslation("apply"); ?></button>
                <button type="button" class="btn btn-default"
                        name="restart_cfg_button"><?php echo \Engine\LanguageManager::GetTranslation("cancel"); ?></button>
            </div>
        </form>
    </div>
    <script>
