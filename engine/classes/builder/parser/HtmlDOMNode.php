 ...
 ***************************************************************************
 *
 * As author of this project (not this script), I want to say that I just
 * format this to it doesn't contain any unnecessary functions.
 *
 */

namespace Builder\Parser;

use Builder\Parser\Traits\HtmlHandler;
