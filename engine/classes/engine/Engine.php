...
class Engine
{
    ...
    private static function includeDependencies(string $className) {;
        ...
        $foldersExist = file_exists("$path/$moduleName/controllers/") && file_exists("$path/$moduleName/models/");
        $inPathToSub = in_array($breadcrumbs[1], ["Controllers", "Models"]);
    ...
    public static function LoadEngine()
    {
        ...
        spl_autoload_register("self::includeDependencies");
