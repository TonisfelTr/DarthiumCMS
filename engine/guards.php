...
namespace Guards {
    ...
    class Logger{
        ...
        public static function addErrorLog(string $logText) : bool {
            ...
            return file_put_contents(self::ERRORS_PATH . "errors.log", "[$nowTime] $selfIdentificator says: $logText");
        }
        ...
        public static function addAccessLog(string $logText) : bool {
            ...
            return file_put_contents(self::ACCESSES_PATH . "access.log", "[$nowTime] $selfIdentificator says: $logText");
        }
        ...
        public static function addVisitLog(string $logText) : bool {
            ...
            return file_put_contents(self::VISITORS_PATH . "visitor.log", "[$nowTime] $selfIdentificator says: $logText");
        }
    }
}