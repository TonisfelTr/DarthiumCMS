...
"page_tip" => "Editing options è category identifiers.",
...
"utc-8"    => "UTC -8:00 Baja California, Pacific Time (USA è Canada)...",
...
"utc+6" => "UTC +6:00 Îìñê, Astana, Dhaka...",
...
"panel_description" => " he enforcing of static page management.",
...
"panel_tip" => "<strong>Âñå ïîëÿ</strong>, in addition to the description, they need to be filled in. The minimum length of the page title is 4 symbolss, and the page text must be at least 20 symbols.",
