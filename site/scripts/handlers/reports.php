...
if (isset($_REQUEST["reports-create"])) {
    if ($user->getUserGroup()->getPermission("report_create")) {
...
if (isset( $_REQUEST["reports-edit"])){
    ...
    if (($user->getUserGroup()->getPermission("report_edit") && $user->getId() == \Guards\ReportAgent::GetReportParam($_REQUEST["rid"], "author"))
...
if (isset ($_REQUEST["reports-edit-answer-edit"])){
    ...
    if ($user->getId() == \Guards\ReportAgent::GetAnswerParam($_REQUEST["ansid"], "authorId") && $user->getUserGroup()->getPermission("report_answer_edit")){
