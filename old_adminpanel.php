...
<head>
    ...
    <link href="adminpanel/templates/Default/css/ap-style.css" rel="stylesheet">
    <link href="adminpanel/templates/Default/css/uploader-style.css" rel="stylesheet">
    <link href="libs/bubblemenu/popup.css" rel="stylesheet">
    <link href="adminpanel/templates/Default/css/icon.ico" rel="icon">
    {PLUGINS_STYLESHEETS}
    ...
    <script src="libs/bubblemenu/bubbletooltip.js"></script>
    {PLUGIN_HEAD_JS}
...
<!--<div class="side-navbar">
    ...
    <button type="button" class="side-nav-btn" data-tooltip="Управление контентом" data-menu-block="content-pm"><span
                class="glyphicon glyphicon-pencil"></span></button>
    <button type="button" class="side-nav-btn" data-tooltip="Рассылка сообщений" data-menu-block="postman-pm"><span
                class="glyphicon glyphicon-file"></span></button>
    <?php if (\Engine\PluginManager::GetPluginsList()) { ?>
...
<div class="popup-menu" id="settings-pm">
    <a class="pm-btn" href="?p=settings">
        ...
        Настройки
        <p>Настройки сайта и движка.</p>
    </a>
    <a class="pm-btn" href="?p=logs">
        <span class="glyphicon glyphicon-transfer"></span>
        История
        <p>Просмотр истории действий в админпанели.</p>
    </a>
</div>
<div class="popup-menu" id="users-pm">
    <a class="pm-btn" href="?p=users">
        <span class="glyphicon glyphicon-user"></span>
        Пользователи
        <p>Создание, удаление, редактирование и блокировка пользователей сайта.</p>
    </a>
    <a class="pm-btn" href="?p=groups">
        <span class="glyphicons glyphicons-group"></span>
        Группы
        <p>Управление привилегиями групп и их списком.</p>
    </a>
</div>
<div class="popup-menu" id="content-pm">
    <a class="pm-btn" href="?p=rules">
        <span class="glyphicons glyphicons-list"></span>
        Правила
        <p>Редактирование правил сайта.</p>
    </a>
    <a class="pm-btn" href="?p=categories">
        <span class="glyphicons glyphicons-show-thumbnails"></span>
        Категории
        <p>Управление категориями сайта: их создание, удаление и манипуляции.</p>
    </a>
    <a class="pm-btn" href="?p=uploadedlist">
        <span class="glyphicons glyphicons-file-cloud-upload"></span>
        Загрузки
        <p>Просмотр загруженных на сайт файлов.</p>
    </a>
    <a class="pm-btn" href="?p=staticc">
        <span class="glyphicons glyphicons-pen"></span>
        Управление статическим контентом
        <p>Добавление, удаление и редактирование статического контента сайта.</p>
    </a>
    <a class="pm-btn" href="?p=reports">
        <span class="glyphicon glyphicon-fire"></span>
        Жалобы
        <p>Управление жалобами пользователей.</p>
    </a>
    <a class="pm-btn" href="?p=teditor">
        <span class="glyphicons glyphicons-brush"></span>
        Дизайн сайта
        <p>Редактирование шаблонов сайта.</p>
    </a>
</div>
<div class="popup-menu" id="postman-pm">
    <a class="pm-btn" href="?p=emailsender">
        <span class="glyphicons glyphicons-file"></span>
        Электронный почтальон
        <p>Отправка Email сообщений всем пользователям.</p>
    </a>
    <a class="pm-btn" href="?p=pmsender">
        <span class="glyphicons glyphicons-file-cloud"></span>
        Почтальон сайта
        <p>Отправка личных сообщений каждому зарегистрированному пользователю.</p>
    </a>
</div>
...
if (true) { ?>
<div class="popup-menu" id="plugins-pm">
    <?php
    foreach ($installedPlugins as $plugin) { ?>
                <a class="pm-btn" href="?plp=<?= $plugin["codeName"] ?>"><span
                            class="glyphicons glyphicons-log-in"></span> <?= $plugin["name"] ?>
                <p><?= (!\Engine\PluginManager::IsTurnOn($plugin["codeName"]) ?
                ...
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand"
                           href="#"><?= \Engine\LanguageManager::GetTranslation("navigation"); ?></a>
                    </div>
                    <div class="navbar-collapse collapse" id="navbar">
                        <ul class="nav navbar-nav">
                            <li <?php if (!isset($_GET["p"]) && !isset($_GET["plp"])) {
                                echo "class='active'";
                            } ?>>
                                <a href="adminpanel.php"><?php echo \Engine\LanguageManager::GetTranslation("home"); ?></a>
                            </li>
                            <li <?php if (isset($_GET["p"])) {
                                if ($_GET["p"] == 'settings') {
                                    echo "class='active'";
                                }
                            } ?>>
                                <a href="?p=settings"><?php echo \Engine\LanguageManager::GetTranslation("settings"); ?></a>
                            </li>
                            <li <?php if (isset($_GET["p"])) {
                                if ($_GET["p"] == 'reports') {
                                    echo "class='active'";
                                }
                            } ?>><a href="?p=reports"><?php echo \Engine\LanguageManager::GetTranslation("reports"); ?>
                                    <?php if (($rc = \Guards\ReportAgent::GetUnreadedReportsCount()) > 0) { ?><span
                                            class="adminpanel-reports-inc"><span
                                            class="glyphicons glyphicons-bell"></span> <?php echo $rc; ?>
                                        </span><?php } ?></a></li>
                            <li <?php if (isset($_GET["p"])) {
                                if ($_GET["p"] == 'logs') {
                                    echo "class='active'";
                                }
                            } ?>><a href="?p=logs"><?php echo \Engine\LanguageManager::GetTranslation("logs"); ?></a>
                            </li>
                        </ul>
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <a href="index.php"><?php echo \Engine\LanguageManager::GetTranslation("to_site_home"); ?></a>
                            </li>
        ...
        if (isset($_GET["res"])) { ?>
            ...
            if ($_GET["res"] == "1") { ?>
                <div class="alert alert-danger"><span
                        class="glyphicon glyphicon-alert"></span> <?php echo \Engine\LanguageManager::GetTranslation("not_permited"); ?>
                </div><?php }
            if ($_GET["res"] == "2") { ?>
                <div class="alert alert-danger"><span
                        class="glyphicon glyphicon-alert"></span> <?php echo \Engine\LanguageManager::GetTranslation("no_page_in_module"); ?>
                </div><?php }
            if (isset($_GET["p"])) {
                if ($_GET["p"] == "settings") {
                    if ($_GET["res"] == "2s") { ?>
                        <div class="alert alert-success"><span
                                class="glyphicon glyphicon-ok"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_save"); ?>
                        </div><?php }
                    if ($_GET["res"] == "2n") { ?>
                        <div class="alert alert-danger"><span
                                class="glyphicon glyphicon-alert"></span> <?php echo \Engine\LanguageManager::GetTranslation("settings_not_save"); ?>
                        </div><?php }
                }
                if ($_GET["p"] == "groups") {
                    if ($_GET["res"] == "3se") { ?>
                        <div class="alert alert-success"><span
                                class="glyphicon glyphicon-ok"></span> <?php echo \Engine\LanguageManager::GetTranslation("custom_info_group"); ?>
                        </div><?php }
                    if ($_GET["res"] == "3spc") { ?>
                        <div class="alert alert-success"><span
                                class="glyphicon glyphicon-ok"></span> <?php echo \Engine\LanguageManager::GetTranslation("permissions_change_and_set_success"); ?>
                        </div><?php }
                    if ($_GET["res"] == "3sgc") { ?>
                        <div class="alert alert-success"><span
                                class="glyphicon glyphicon-ok"></span> <?php echo \Engine\LanguageManager::GetTranslation("group_create_success"); ?>
                        </div><?php }
                    if ($_GET["res"] == "3sgd") { ?>
                        <div class="alert alert-success"><span
                                class="glyphicon glyphicon-ok"></span> <?php echo \Engine\LanguageManager::GetTranslation("group_remove_success"); ?>
                        </div><?php }
                    if ($_GET["res"] == "3nlfs") { ?>
                        <div class="alert alert-danger"><span
                                class="glyphicon glyphicon-alert"></span> <?php echo \Engine\LanguageManager::GetTranslation("invalid_group_name"); ?>
                        </div><?php }
                    if ($_GET["res"] == "3nmfts") { ?>
                        <div class="alert alert-danger"><span
                                class="glyphicon glyphicon-alert"></span> <?php echo \Engine\LanguageManager::GetTranslation("invalid_group_name"); ?>
                    ...
                    if ($_GET["res"] == "3ne") { ?>
                        <div class="alert alert-danger"><span
                                class="glyphicon glyphicon-alert"></span> <?php echo \Engine\LanguageManager::GetTranslation("not_permited_change_custom_info_group"); ?>
                        </div><?php }
                    if ($_GET["res"] == "3npc") { ?>
                        <div class="alert alert-danger"><span
                                class="glyphicon glyphicon-alert"></span> <?php echo \Engine\LanguageManager::GetTranslation("not_permited_change_perms_group"); ?>
                        </div><?php }
                    if ($_GET["res"] == "3ngc") { ?>
                        <div class="alert alert-danger"><span
                                class="glyphicon glyphicon-alert"></span> <?php echo \Engine\LanguageManager::GetTranslation("group_create_error"); ?>
                        </div><?php }
                    if ($_GET["res"] == "3ngd") { ?>
                        <div class="alert alert-danger"><span
                                class="glyphicon glyphicon-alert"></span> <?php echo \Engine\LanguageManager::GetTranslation("group_remove_error"); ?>
                        </div><?php }
                    if ($_GET["res"] == "3ndd") { ?>
                        <div class="alert alert-danger"><span
                                class="glyphicon glyphicon-alert"></span> <?php echo \Engine\LanguageManager::GetTranslation("special_group_remove_denied"); ?>
                        </div><?php }
                    if ($_GET["res"] == "3ngs") { ?>
                        <div class="alert alert-info"><span
                                class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("not_choice_group"); ?>
                        </div><?php }
                    if ($_GET["res"] == "3ngmm") { ?>
                        <div class="alert alert-info"><span
                                class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("failed_to_move_users_group"); ?>
                        </div><?php }
                    if ($_GET["res"] == "3ngsd") { ?>
                        <div class="alert alert-info"><span
                                class="glyphicon glyphicon-info-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("not_permited_remove_custom_group"); ?>
                        </div><?php }
                }
                if ($_GET["p"] == "users") {
                    if ($_GET["res"] == "4ncdu") { ?>
                    ...
                    if ($_GET["res"] == "4sdu") { ?>
                        <div class="alert alert-success"><span
                                class="glyphicon glyphicon-ok"></span> <?php echo \Engine\LanguageManager::GetTranslation("users_have_been_successfully_deleted"); ?>
                        </div><?php }
                    if ($_GET["res"] == "4ndu") { ?>
                        <div class="alert alert-success"><span
                                class="glyphicon glyphicon-alert"></span> <?php echo \Engine\LanguageManager::GetTranslation("users_have_not_been_deleted"); ?>
                        </div><?php }
                    if ($_GET["res"] == "4ndus") { ?>
                ...
                if ($_GET["p"] == "staticc") {
                    ...
                    if ($_GET["res"] == "7nbn") { ?>
                        <div class="alert alert-danger"><span
                                class="glyphicon glyphicon-warning-sign"></span> <?php echo \Engine\LanguageManager::GetTranslation("page_name_too_small"); ?>
                        </div><?php }
                    if ($_GET["res"] == "7nst") { ?>
                        <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span>
                ...
                if ($_GET["p"] == "teditor") {
                    if ($_GET["res"] == "10scf") { ?>
                        <div class="alert alert-success"><span
                                class="glyphicon glyphicon-ok"></span> <?php echo \Engine\LanguageManager::GetTranslation("file_has_been_edited_success"); ?>
                        </div><?php }
                    if ($_GET["res"] == "10fcf") { ?>
                        <div class="alert alert-danger"><span
                                class="glyphicon glyphicon-alert"></span> <?php echo \Engine\LanguageManager::GetTranslation("file_has_not_been_edited"); ?>
                        </div><?php }
                    if ($_GET["res"] == "10fne") { ?>
                        <div class="alert alert-danger"><span
                                class="glyphicon glyphicon-alert"></span> <?php echo \Engine\LanguageManager::GetTranslation("file_doesnot_exist"); ?>
                        </div><?php }
                }
            }
            ?></div><?php }
...
<?php
} elseif (isset($_GET["p"]) && isset($_GET["plp"])) {
    include_once "adminpanel/errors/invalidrequest.php";
} elseif (isset($_GET["p"])) { ?>
    <div class="container-fluid">
        <?php if (file_exists("adminpanel/" . $_GET["p"] . ".php")) {
            include_once "adminpanel/" . $_GET["p"] . ".php";
        } elseif ($_GET["p"] == "forbidden") {
            include_once "adminpanel/errors/forbidden.php";
        } else {
            include_once "adminpanel/errors/notfound.php";
        } ?>
    </div>
...
<?php } else {
    ...
    <div class="footer">
        <p class="footer">
            ...
            Все права защищены <?=date("Y")?> год.<br>
        </p>
    </div>
    <script>
        <?php include_once "./site/scripts/SpoilerController.js"; ?>
        $(".side-nav-btn").on("mouseenter", function () {
            let _ = new BubbleMenu()
            _.showTooltip(this);
        })
